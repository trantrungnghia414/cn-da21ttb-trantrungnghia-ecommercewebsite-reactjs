...
function BrandForm() {
  ...
  const fetchBrands = async () => { // Lấy dữ liệu thương hiệu cần chỉnh sửa
    const response = await axiosAppJson.get(`/brands/${slug}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditMode) {
        await axiosAppJson.put(`/brands/${slug}`, formData);
      } else {
        await axiosAppJson.post('/brands', formData);
      }
