...
function SupplierList() {
    ...
    const fetchSuppliers = async () => {
        try {
            ...
            const response = await axiosAppJson.get("/api/suppliers");
    ...
    const handleDelete = async (id) => {
        if (
            window.confirm("Bạn có chắc chắn muốn xóa nhà cung cấp này không?")
        ) {
            try {
                await axiosAppJson.delete(`/api/suppliers/${id}`);
                setSuppliers(
